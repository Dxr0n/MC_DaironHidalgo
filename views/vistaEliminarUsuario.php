...
?>
    <div class="body">
        ...
        <?php if (!$usuario) { ?>
            <form action="<?php get_controllers('controladorIngresarUsuario.php'); ?>" method="POST" autocomplete="off">
        ...
        <?php } else { ?>
            <div class="mensaje-confirmacion">
                ...
                <form action="<?php get_controllers('controladorIngresarUsuario.php'); ?>" method="POST">
